...
public class DigitalSign {
    ...
    public static void main(String[] args) throws Exception {
        String appKey = "3C7236093C87426536B813DD8BAAF006";
        String secretKey = "d76c641350e14a23a36b4e4f8b77f4d7";
        CreditReq req = new CreditReq();
        req.setAppKey(appKey);
        req.setEntCode("91140109MA0KBQGP2H");
        req.setEntName("太原市耀希影城有限公司");
        req.setUploadTime("2020-01-14 12:00:00");
        req.setCheckTime("2020-01-15 15:21:35");
        String sign = getDigitalSign(req, secretKey);
        log.info("sign->{}", sign);
    }
